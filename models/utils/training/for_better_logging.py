...
def init_for_better_logger(args, plot, writer=None):
    ...
    setup_fields = {
        ...
        "surrogate_pretrain_subtree_depth_percent_min": getattr(args, "surrogate_pretrain_subtree_depth_percent_min", None),
        "surrogate_pretrain_subtree_depth_percent_max": getattr(args, "surrogate_pretrain_subtree_depth_percent_max", None),
        ...
        "compression_surrogate_log_soft_aux": getattr(args, "compression_surrogate_log_soft_aux", None),
        "compression_good_step_boost": getattr(args, "compression_good_step_boost", None),
        "compression_good_step_prefreeze_scale": getattr(args, "compression_good_step_prefreeze_scale", None),
        "compression_good_step_extra_surrogate_steps": getattr(args, "compression_good_step_extra_surrogate_steps", None),
        "actual_compression_guard": getattr(args, "actual_compression_guard", None),
        "actual_guard_patience": getattr(args, "actual_guard_patience", None),
        "actual_guard_tolerance": getattr(args, "actual_guard_tolerance", None),
        "skip_optimizer_on_actual_fallback": getattr(args, "skip_optimizer_on_actual_fallback", None),
        "checkpoint_actual_source": getattr(args, "checkpoint_actual_source", None),
        "checkpoint_full_cloud_min_count": getattr(args, "checkpoint_full_cloud_min_count", None),
        "checkpoint_min_optimizer_step_ratio": getattr(args, "checkpoint_min_optimizer_step_ratio", None),
        "train_full_cloud_actual_interval": getattr(args, "train_full_cloud_actual_interval", None),
        "train_full_cloud_val_frames": getattr(args, "train_full_cloud_val_frames", None),
        ...
        "target_add_ratio": getattr(args, "target_add_ratio", None),
        "max_add_ratio": getattr(args, "max_add_ratio", None),
        "repair_add_hard_threshold": getattr(args, "repair_add_hard_threshold", None),
        "repair_move_hard_threshold": getattr(args, "repair_move_hard_threshold", None),
        "sparsepcgc_move_source_prior_weight": getattr(args, "sparsepcgc_move_source_prior_weight", None),
...
def log_for_better_step(
    ...
    *,
    ...
    surrogate_lr_values = for_better_lrs(getattr(loss_obj, "surrogate_optimizer", None))
    fields = {
        ...
        "current_lr_main": lr_values,
        "current_lr_surrogate": surrogate_lr_values,
        ...
        "sparsepcgc_aux_used_for_backprop": compression_row.get("sparsepcgc_aux_used_for_backprop"),
        "sparsepcgc_aux_weight_effective": compression_row.get("sparsepcgc_aux_weight_effective"),
        "sparsepcgc_aux_gating_reason": compression_row.get("sparsepcgc_aux_gating_reason"),
        "corr_sparsepcgc_aux_actual_rolling": compression_row.get("corr_sparsepcgc_aux_actual_rolling"),
        "sign_match_sparsepcgc_aux_actual_rolling": compression_row.get("sign_match_sparsepcgc_aux_actual_rolling"),
        ...
        "target_clamp_rate": compression_row.get("target_clamp_rate"),
        "grad_source": compression_row.get("grad_source"),
        "actual_forward_value": compression_row.get("actual_forward_value"),
        "surrogate_loss_for_grad": compression_row.get("surrogate_loss_for_grad"),
        "proxy_aux_for_grad": compression_row.get("proxy_aux_for_grad"),
        "teacher_type": compression_row.get("teacher_type"),
        "full_cloud_teacher_used": compression_row.get("full_cloud_teacher_used"),
        "teacher_gap_percent": compression_row.get("teacher_gap_percent"),
        "replay_age": compression_row.get("replay_age"),
        ...
        "gt_actual_bit": compression_row.get("gt_actual_bit"),
        "gen_actual_bit": compression_row.get("gen_actual_bit"),
        "compression_main_grad_scale": compression_row.get("compression_main_grad_scale"),
        "compression_main_grad_scale_reason": comp_debug.get("compression_main_grad_scale_reason"),
        ...
        "move_source_prior_mean": operation_row.get("move_source_prior_mean"),
        ...
        "add_soft_ratio": operation_row.get("add_soft_ratio"),
        "add_hard_ratio": operation_row.get("add_hard_ratio"),
        "add_amount_mean": operation_row.get("add_amount_mean"),
        "add_amount_std": operation_row.get("add_amount_std"),
        "add_branch_grad_norm": operation_row.get("add_branch_grad_norm"),
        "add_amount_grad_norm": operation_row.get("add_amount_grad_norm"),
        "prune_soft_ratio": operation_row.get("prune_soft_ratio"),
        "prune_hard_ratio": operation_row.get("prune_hard_ratio"),
        "prune_amount_mean": operation_row.get("prune_amount_mean"),
        "prune_amount_std": operation_row.get("prune_amount_std"),
        "prune_branch_grad_norm": operation_row.get("prune_branch_grad_norm"),
        "prune_amount_grad_norm": operation_row.get("prune_amount_grad_norm"),
        "adjust_soft_ratio": operation_row.get("adjust_soft_ratio"),
        "adjust_hard_ratio": operation_row.get("adjust_hard_ratio"),
        "adjust_amount_mean": operation_row.get("adjust_amount_mean"),
        "adjust_amount_std": operation_row.get("adjust_amount_std"),
        "adjust_branch_grad_norm": operation_row.get("adjust_branch_grad_norm"),
        "adjust_amount_grad_norm": operation_row.get("adjust_amount_grad_norm"),
        "operation_entropy": operation_row.get("operation_entropy"),
        "operation_prob_floor_applied": operation_row.get("operation_prob_floor_applied"),

...
def log_runtime_setup(writer, args):
    ...
    writer.write(
        ...
        f"max_restores={int(getattr(args, 'actual_guard_max_restores', 1))}, "
        f"max_restore_age={int(getattr(args, 'actual_guard_max_restore_age_episodes', 16))}, "
        f"rebase_stale={bool(getattr(args, 'actual_guard_rebase_stale_best', True))}, "

...
FULL_CLOUD_AMOUNT_CANDIDATE_COLUMNS = [
    ...
    "candidate_selected_for_actual_reason",
    "is_wide_probe",
    "is_sequence_memory",
    ...
    "teacher_residual",
    "residual_error",
    "residual_teacher_clamped",
    "final_ratio",
    "is_noop",
    "actual_requested",
    "actual_finished",
    "full_cloud_input_points",
    "full_cloud_drop_count",
    "drop_count",
    "where_mode",
    "effective_where_mode",
    "macro_ratio",
    "micro_ratio",
    "macro_selected_block_count",
    "macro_drop_count",
    "micro_drop_count",
    "total_drop_count",
    "selected_block_count",
    "micro_selected_block_count",
    "max_drop_count_per_block",
    ...
    "actual_bit_objective",
    "actual_objective_bit_source",
    "actual_total_bits_before",
    "actual_total_bits_after",
    "actual_base_bits",
    "actual_raw_bits",
    "actual_billed_bits",
    ...
    "geom_loss",
    "predicted_delta",
    "teacher_compared_in_actual_pool",
    "teacher_is_best",
    "teacher_label",
    "teacher_source",
    "selected_is_best",
...
COMPRESSION_METRIC_COLUMNS = [
    ...
    "ana_den6_reference_anchor_active",
    "ana_den6_reference_expected_saved_percent",
    "actual_value_source",
    "fresh_actual",
    "cached_actual",
    ...
    "full_cloud_verified_noop_guard_used",
    ...
    "full_cloud_amount_pred_residual_raw",
    "full_cloud_amount_selected_base_bin",
    ...
    "full_cloud_amount_candidate_count",
    "full_cloud_amount_actual_eval_count",
    "full_cloud_amount_actual_requested_count",
    "full_cloud_amount_actual_finished_count",
    "full_cloud_amount_teacher_source",
    "full_cloud_amount_teacher_ratio",
    "full_cloud_amount_teacher_base_bin",
    "full_cloud_amount_teacher_residual",
    "full_cloud_amount_oracle_best_ratio",
    "full_cloud_amount_raw_oracle_best_ratio",
    "full_cloud_amount_oracle_best_actual_delta",
    "full_cloud_amount_oracle_best_objective_delta",
    "full_cloud_amount_selected_ratio",
    "full_cloud_amount_selected_actual_delta",
    "full_cloud_amount_selected_objective_delta",
    "full_cloud_amount_oracle_gap",
    "full_cloud_amount_selected_is_best",
    "full_cloud_amount_selected_is_raw_best",
    "full_cloud_amount_raw_oracle_gap",
    "full_cloud_amount_actual_finished_nonselected_count",
    "full_cloud_amount_wide_probe_due",
    ...
    "amount_value_loss",
    "amount_advantage",
    "sequence_amount_baseline",
    "amount_class_histogram",
    "amount_max_class_rate",
    "amount_selected_ratio_mean",
    "amount_selected_ratio_std",
    "full_cloud_amount_entropy",
    ...
    "full_cloud_amount_cls_loss",
    "full_cloud_amount_value_loss",
    "full_cloud_amount_rank_loss",
    "full_cloud_amount_geom_guard_loss",
    "full_cloud_amount_ratio_reg_loss",
    "full_cloud_amount_noop_guard_loss",
    "full_cloud_amount_entropy_loss",
    "full_cloud_amount_residual_loss",
    "full_cloud_amount_residual_error",
    "full_cloud_amount_residual_enabled",
    "full_cloud_amount_residual_max",
    "full_cloud_amount_residual_teacher_clamped",
    "full_cloud_amount_ratio_hist_selected",
    "full_cloud_amount_ratio_hist_teacher",
    "full_cloud_amount_fine_probe_enabled",
    "full_cloud_amount_residual_probe_enabled",
    "full_cloud_amount_total_loss",
    "full_cloud_amount_step_time",
    "full_cloud_amount_actual_wall_time_total",
    "full_cloud_amount_actual_wall_time_max",
    "full_cloud_amount_actual_dispatch_time",
    "full_cloud_amount_actual_gather_time",
    "full_cloud_amount_reuse_where_ranking",
    ...
    "sparsepcgc_actual_worker_pool_used",
...
CHECKPOINT_METRIC_COLUMNS = [
    ...
    "full_cloud_val_sample_signature",
    "full_cloud_val_geometry",
    "full_cloud_val_fixed_objective",
    "fixed_validation_geom_reference",
